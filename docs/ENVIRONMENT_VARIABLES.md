...
| 변수 | 필수 여부 | 채널 | 사용처 |
|---|---|---|---|
| `SLACK_WEBHOOK_URL` | 필수 | `#value-report` | `slack_report.py`, `backtest_report_slack.py` |
| `SLACK_ALERT_WEBHOOK_URL` | 필수 | `#realtime-alerts` | `slack_scanner.py`, `order_monitor.py`, `trading_health_check.py` |
